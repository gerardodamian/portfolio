...
const Experiencia = () => {
    ...
    return (
        <div className="container mt-44 mx-auto px-4 lg:px-8 md:px-14 w-full">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center bg-gray-50 rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
